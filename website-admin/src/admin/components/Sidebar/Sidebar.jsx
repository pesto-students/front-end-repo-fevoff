            ...
            <div className="mt-6 flex flex-1 flex-col justify-between ">
                <nav className="space-y-6">
                    <div className="space-y-3 ">
                        ...
                        {/* <NavLink to={basePath + "users"} className={({ isActive }) => isActive ? "bg-white flex items-center rounded-lg  py-3" : "flex transform items-center rounded-lg  text-gray-200 transition-colors duration-300 hover:bg-gray-50 hover:text-gray-700 py-3"}>
                            <UserRoundPlus className="h-5 w-5" aria-hidden="true" />
                            <span className="mx-2 text-sm font-medium">Manage Users</span>
                        </NavLink> */}

                        <div className="dropdown w-full">
                            <NavLink className={"flex transform items-center rounded-lg  text-gray-200 transition-colors duration-300 py-3 justify-between"} role='btn' >
                                <div className='flex'>
